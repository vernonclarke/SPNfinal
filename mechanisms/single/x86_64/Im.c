...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "modulation_Im", _hoc_modulation,
 "rates_Im", _hoc_rates,
 0, 0
};
#define modulation modulation_Im
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Im /Users/euo9382/Documents/SPNmaster/mechanisms/single/Im.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   gIm = gbar * m * modulation ( _threadargs_ ) ;
   ik = gIm * ( v - ek ) ;
   }
 _current += ik;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/euo9382/Documents/SPNmaster/mechanisms/single/Im.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
