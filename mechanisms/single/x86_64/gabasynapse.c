...
#define nrn_init _nrn_init__gabasynapse
#define _nrn_initial _nrn_initial__gabasynapse
#define nrn_cur _nrn_cur__gabasynapse
#define _nrn_current _nrn_current__gabasynapse
#define nrn_jacob _nrn_jacob__gabasynapse
#define nrn_state _nrn_state__gabasynapse
#define _net_receive _net_receive__gabasynapse 
#define state state__gabasynapse 
...
#define damod _p[4]
#define damod_columnindex 4
#define maxMod _p[5]
#define maxMod_columnindex 5
#define max2 _p[6]
#define max2_columnindex 6
#define level _p[7]
#define level_columnindex 7
#define lev2 _p[8]
#define lev2_columnindex 8
#define i _p[9]
...
#define modulation modulation_gabasynapse
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 gabasynapse /Users/euo9382/Documents/SPNmaster/mechanisms/single/gabasynapse.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   g = ( B - A ) * modulation ( _threadargscomma_ maxMod , max2 , level , lev2 ) ;
   i = g * ( v - erev ) ;
   }
 _current += i;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/euo9382/Documents/SPNmaster/mechanisms/single/gabasynapse.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
