...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 bk /Users/euo9382/Documents/SPNmaster/mechanisms/single/bk.mod\n");
...
static int _reset;
static char *modelname = "BK-type calcium activated K channel";
...
static int  rate ( _threadargsprotocomma_ double _lv , double _lca ) {
  ...
  _lz = 1e-3 * 2.0 * FARADAY / ( R * ( celsius + 273.15 ) ) ;
   _la = 0.48 * _lca / ( _lca + k1 * exp ( - 0.84 * _lz * _lv ) ) ;
   _lb = 0.28 / ( 1.0 + _lca / ( k4 * exp ( - _lz * _lv ) ) ) ;
   _lsum = _la + _lb ;
   oinf = _la / _lsum ;
   otau = 1.0 / _lsum ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/euo9382/Documents/SPNmaster/mechanisms/single/bk.mod";
static const char* nmodl_file_text = 
