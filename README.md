...
5. **Create a conda environment**
   ...
   (Processor: `Intel(R) Core(TM) i5-8350U CPU @ 1.70GHz   1.90 GHz` and Installed RAM: `32.0 GB`, the code ran extremely

   slowly in the Windows environment (approx. 9-fold slower) when compared to a `MacBook M2 pro 32GB`.
